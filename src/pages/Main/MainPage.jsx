		...
		<main className={styles.main}>
			...
			<div className={styles.aboutMe}>
				...
				<div className={styles.aboutText}>
					...
					<div className={styles.desc}>В последний год проходила стажировку в <span className={styles.plum}>QSoft</span> по направлению Frontend-разработчик и курсы у <span className={styles.plum}>PurpleSchool</span> по JavaScript и React.</div>
